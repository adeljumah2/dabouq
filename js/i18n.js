(function () {
  ...
  const dict = {
    en: {
      ...
      'about.c1.title': 'Integrated Group',
      ...
      'footer.cta.desc': 'Partner with a group that integrates industry, nutrition, and mobility.',
      'footer.cta.btn': 'Start a Conversation',
      'footer.brand': 'A premier investment company with regional operations across the Middle East.',
      ...
      'careers.nationality.ph': 'e.g. Saudi, Jordanian, Egyptian',
      'careers.city': 'City',
      'careers.city.ph': 'e.g. Riyadh, Jeddah, Dammam',
      'careers.iqama': 'Profession on Iqama',
      'careers.iqama.ph': 'As written on residence permit',
      ...
      'meta.home': 'Dabouq Group | Leading Investment & Industrial Group | Saudi Arabia',
    ...
    ar: {
      ...
      'footer.cta.desc': 'شارك مجموعة تدمج الصناعة والتغذية والتنقّل.',
      'footer.cta.btn': 'ابدأ المحادثة',
      'footer.brand': 'شركة استثمارية رائدة بعمليات إقليمية عبر الشرق الأوسط.',
      'footer.nav': 'القائمة',
      ...
      'careers.nationality.ph': 'مثال: سعودي، أردني، مصري',
      'careers.city': 'المدينة',
      'careers.city.ph': 'مثال: الرياض، جدة، الدمام',
      'careers.iqama': 'المهنة على الإقامة',
      'careers.iqama.ph': 'كما هو مكتوب في الإقامة',
